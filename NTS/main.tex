...
\begin{figure}
  \imgw{500}{graphics/cone_NAT.svg}
  \caption{Cone NAT port allocation.\label{fig:cone_NAT}}
\end{figure}

\begin{figure}
  \imgw{500}{graphics/symmetric_NAT.svg}
...
\begin{figure}
  \imgw{600}{graphics/UDP_Hole_Punching_RCN.svg}
...
\begin{figure}
  \imgw{600}{graphics/UDP_Hole_Punching_SN_failure.svg}
