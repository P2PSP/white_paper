...
only one external (public) peer $P^t_e$, and that a new
...
\begin{figure}
  \fig{400}{6cm}{UDP_Hole_Punching_RCN}
...
\begin{figure}
  \fig{400}{6cm}{UDP_Hole_Punching_SN_failure}
