...
capacity, the lower the \gls{round-time}. \leorem{Si tiene qie mandar más, ¿cómo va a tener menor round time?} {\color{red} Claro, a menor round-time, mayor capacidad}
...
ratio). \leo{\hl{leo:} me lo explique mejor.} {\color{red} Si un
  monitor no pierde chunks, entonces recibe m\'as chunks del splitter
  y por tanto, el resto de peers no tienen que transmitir tanto.}
