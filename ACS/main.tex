...
capacity, the lower the \gls{round-time}. \leo{\hl{leo:} Si tiene qie mandar más, ¿cómo va a tener menor round time?}

ACS should be used if we want some peers to \leochange{put}{contriuute with} the uploading
...
ratio). \leo{\hl{leo:} me lo explique.}
