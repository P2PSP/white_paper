...
streaming server,
%(the nomenclature used for describing DBS is shown in Table~\ref{tab:DBS_nomenclature}),
...
its team, where it can be up to $N$ peers. Each peer gathers
the chunks from the splitter and the rest of peers of the team, and
sends them to a player.
\begin{comment}
