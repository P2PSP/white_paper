...
\begin{tikzpicture}
  ...
  \begin{pgfonlayer}{timelines}
    \coordinate (Pla) at ($(Player.center) + (0.0,-17)$);
    \draw[myptr] ($(Player.center) + (0,-2ex)$) -- (Pla);  
    \coordinate (Bal) at ($(Balancer.center) + (0.0,-17)$);
    \draw[myptr] ($(Balancer.center) + (0,-2ex)$) -- (Bal);
    \coordinate (Pee) at ($(Peer.center) + (0.0,-17)$);
    \draw[myptr] ($(Peer.center) + (0,-2ex)$) -- (Pee);
    \coordinate (Sp1) at ($(Splitter1.center) + (0.0,-17)$);
    \draw[myptr] ($(Splitter1.center) + (0,-2ex)$) -- (Sp1);
    \coordinate (Sp2) at ($(Splitter2.center) + (0.0,-17)$);
    \draw[myptr] ($(Splitter2.center) + (0,-2ex)$) -- (Sp2);
    \coordinate (Tra) at ($(Tracker.center) + (0.0,-17)$);
