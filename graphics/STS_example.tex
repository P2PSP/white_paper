...
\begin{tikzpicture}
  ...
  \draw[myptr] (Pe00) -- (Ba00) node [pos=0.5,fill=white!100] {$\mathtt{I'm~new}$};
  \draw[myptr] (S100) -- (Tr002) node [pos=0.25,fill=white!100] {$\mathtt{I'm~new}$};
  \draw[myptr] (S200) -- (Tr001) node [pos=0.5,fill=white!100] {$\mathtt{I'm~new}$};
