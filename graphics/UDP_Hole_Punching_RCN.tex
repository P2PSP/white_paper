...
\begin{tikzpicture}
  ...
  \path let \p{NAT A}=(NAT A),\p{07}=(07) in node (NA07) at (\x{NAT A},\y{07}) [fill=white!10,draw,rounded corners] {$A_0$};
  ...
  \draw[myptr] (NA08) -- (PA08) node [pos=0.5,fill=white!100,draw,rounded corners] {\{$(B,B_0)$\}};
  ...
  \path let \p{NAT B}=(NAT B),\p{09}=(09) in node (NB09) at (\x{NAT B},\y{09}) [fill=white!100,draw,rounded corners] {$B_0$};
  ...
  \path let \p{NAT A}=(NAT A),\p{11}=(11) in node (NA11) at (\x{NAT A},\y{11}) [fill=white!100,draw,rounded corners] {$A_0$};
  ...
  \path let \p{NAT A}=(NAT A),\p{14}=(14) in node (NA14) at (\x{NAT A},\y{14}) [fill=white!100,draw,rounded corners] {$A_0$};
  \draw [myptr] (NB14) -- (NA14) node [pos=0.25,fill=white!100] {$\mathtt{ack}~P_2$};

  % 15
  \node (15) at ($(14) + (0,-3ex)$) {15};
  \path let \p{NAT A}=(NAT A),\p{15}=(15) in node (NA15) at (\x{NAT A},\y{15}) [fill=white!100,draw,rounded corners] {$A_0$};
  ...
  \path let \p{NAT B}=(NAT B),\p{15}=(15) in node (NB15) at (\x{NAT B},\y{15}) [fill=white!100,draw,rounded corners] {$B_0$};
  ...
  \path let \p{NAT A}=(NAT A),\p{18}=(18) in node (NA18) at (\x{NAT A},\y{18}) [fill=white!100,draw,rounded corners] {$A_0$};
  \path let \p{NAT B}=(NAT B),\p{18}=(18) in node (NB18) at (\x{NAT B},\y{18}) [fill=white!100,draw,rounded corners] {$B_0$};
