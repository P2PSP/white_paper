...
teams in hybrid overlays, where those users that run a local peer to
...
communicates\footnote{This is a reliable communication. Reliable
  ...
  indicated.}  to the load balancer to tell it that there is a peer
...
\begin{figure*}
  \fig{900}{9cm}{STS} \caption{Procedures run by the load balancer,
