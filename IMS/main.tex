...
address and port. The splitter do a similar check: for all those peers
that are in the same local network that then splitter, the splitter
sends the chunk to the multicast channel
